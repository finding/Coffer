...
## Diff Stats
```
 src/services/variableStorage.ts | 67 +++++++++++++++++++++++++++++++++++++++++
 1 file changed, 67 insertions(+)
```

## Full Diff
diff --git a/src/services/variableStorage.ts b/src/services/variableStorage.ts
new file mode 100644
index 0000000..fc60cb7
--- /dev/null
+++ b/src/services/variableStorage.ts
@@ -0,0 +1,67 @@
