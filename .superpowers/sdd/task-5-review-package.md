...
## Diff Stats
```
 src/content/bodyRewriter.ts             | 171 ++++++++++++++
 tests/unit/content/bodyRewriter.test.ts | 398 ++++++++++++++++++++++++++++++++
...
diff --git a/tests/unit/content/bodyRewriter.test.ts b/tests/unit/content/bodyRewriter.test.ts
new file mode 100644
index 0000000..0fd5790
--- /dev/null
+++ b/tests/unit/content/bodyRewriter.test.ts
@@ -0,0 +1,398 @@
