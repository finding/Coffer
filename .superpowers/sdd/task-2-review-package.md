...
new file mode 100644
index 0000000..47d2088
--- /dev/null
+++ b/src/types/headerRule.ts
@@ -0,0 +1,23 @@
+// src/types/headerRule.ts
+
+export type HeaderRuleType = 'request' | 'response'
+
+export type HeaderRuleAction = 'add' | 'modify' | 'remove'
+
...
+export type { HeaderRuleType, HeaderRuleAction, HeaderRule, HeaderProfile } from './headerRule'
+
